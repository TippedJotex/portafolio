...
import 'package:tesis/vistas/editar_perfil/form_editar_perfil_contrasena.dart';

class EditarContrasena extends StatelessWidget {
  final Database _userRepository;
  const EditarContrasena({Key key, Database userRepository})
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: BlocProvider<ActualizacionBloc>(
          create: (context) =>
              ActualizacionBloc(dbRepository: _userRepository),
  ...
  Widget _appBar(BuildContext context) {
    return AppBar(
      ...
      backgroundColor: const Color.fromRGBO(56, 175, 151, 0.8),
    );
  }
      ...
      child: SizedBox(
        ...
        child: Form(
          child: Column(
            ...
            children: const [
              Text(
                'Bienvenido a la opcion de editar su contraseña.',
