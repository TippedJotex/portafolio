...
import 'package:tesis/vistas/editar_perfil/form_editar_perfil_correo.dart';

class EditarCorreo extends StatelessWidget {
  final Database _userRepository;
  const EditarCorreo({Key key, Database userRepository})
      ...
      child: Padding(
        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: const [
              Text(
              'Bienvenido a la opcion de editar su correo electronico.',
