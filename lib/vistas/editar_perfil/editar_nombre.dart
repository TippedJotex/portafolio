...
import 'package:tesis/vistas/editar_perfil/form_editar_perfil_nombre.dart';

class EditarNombre extends StatelessWidget {
  final Database _userRepository;
  const EditarNombre({Key key, Database userRepository})
      ...
      child: SizedBox(
        ...
        child: Form(
          child: Column(
            ...
            children: const [
              Text(
              'Bienvenido a la opcion de editar su nombre de usuario.',
