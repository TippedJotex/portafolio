...
class sala_Mensajeria2 extends StatelessWidget {
        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              //print('id de sala rescatada: ' + idSala);
              return Container(
  ...
  void enviarMensaje() {
    ...
    String idUsuario = documento['id usuario'];
    Database()
        .registrarMensaje3(_mensaje.text, idPublicacion, idUsuario, rescate);
    _mensaje.clear();
  }
}
